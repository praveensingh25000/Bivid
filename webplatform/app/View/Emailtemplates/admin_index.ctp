    ...
    <?php
        ...
        <div class="row padding_btm_20">
            ...
            <div class="col-lg-4">
                ...
                <?php echo $this->Html->link('Add New',array('controller'=>'emailtemplates','action'=>'addedit'),array('class' => 'btn btn-default','title' => 'Add New Email Template'));?>                
                </div>
           </div> 
        </div>
                ...
                <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                        ...
                        <tr <?php echo $class;?>>                            
                            ...
                            <td>
                            <?php
                                echo $this->Html->link($this->Html->image("admin/edit.png", array("alt" => "Edit","title" => "Edit")),array('controller'=>'emailtemplates','action'=>'addedit',base64_encode($getData['Emailtemplate']['id'])),array('escape' =>false));
