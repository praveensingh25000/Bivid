<div class="row">  
    ...
    <div class="col-sm-12">
	    ...
	    <label>Upload Post CSV Data<span class="required"> * </span><?php echo $this->Html->link('Download File Format',"/files/postFileFormat.csv",array('escape' =>false));?></label>                
	    <?php echo $this->Form->input('post_csv_file',array('type'=>'file','class'=>'validate[required]')); ?>
	    <?php echo $this->Form->error('post_csv_file',null,array('wrap'=>'span','class'=>'error_form'));?>
